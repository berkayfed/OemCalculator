...
const UIController = (function(){
    ...
    return{
        ...
        clearWarnings:function(){
         const items  = document.querySelectorAll(Selectors.productListİtems)
        ...
        deleteProduct:function(){
            ...
            let items = document.querySelectorAll(Selectors.productListİtems)
            items.forEach(function(item){
                if(item.classList.contains("bg-warning")){
                    item.remove()
                }
